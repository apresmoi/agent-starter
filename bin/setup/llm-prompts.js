...
const llmPrompts = {
  ...
  getOpenAIKey: async () => {
    ...
    console.log(
      `1. Go to ${colors.bright}https://platform.openai.com/settings/organization/api-keys${colors.reset}`
    );
  ...
  displayOllamaInstructions: (model) => {
    ...
    console.log(
      `2. Pull the model by running: ${colors.bright}ollama pull ${model}${colors.reset}`
    );
